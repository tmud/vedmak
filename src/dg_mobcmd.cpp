...
ACMD (do_mportal)
{
  ...
  // Ставим пентаграмму из текущей комнаты где стоит чар в комнату target с длительностью howlong 
  curroom = ch->in_room;
