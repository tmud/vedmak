  ...
  { /*
    ...
    {case 'M':
     ...
     case 'Q':
      ...
      break;
    case 'G':
      sprintf(buf2, "%sдать это %s [%s%d%s], Max : %d, Load%% %d",
	      MYCMD.if_flag ? " тогда " : "",
      ...
      break;
    case 'O':
      sprintf(buf2, "%sзагрузить %s [%s%d%s], Max : %d, Load%% %d",
	      MYCMD.if_flag ? " then " : "",
	      obj_proto[MYCMD.arg1].short_description,
	      cyn, obj_index[MYCMD.arg1].vnum, yel,
	      MYCMD.arg2, MYCMD.arg4
      ...
      break;
    case 'E':
      sprintf(buf2, "%sэкипировать %s [%s%d%s], %s, Max : %d, Load%% %d",
	      MYCMD.if_flag ? " тогда " : "",
	      obj_proto[MYCMD.arg1].short_description,
	      cyn, obj_index[MYCMD.arg1].vnum, yel,
      ...
      break;
    case 'P':
      sprintf(buf2, "%sпоместить %s [%s%d%s] в %s [%s%d%s], Max : %d, Load%% %d",
	      MYCMD.if_flag ? " тогда " : "",
	      obj_proto[MYCMD.arg1].short_description,
	      cyn, obj_index[MYCMD.arg1].vnum, yel,
...
void zedit_disp_arg4(struct descriptor_data *d)
{
  ...
  {case 'O':
   ...
   case 'P':
   case 'G':
    send_to_char("Введите % вероятность лоада (-1=100%%) : ", d->character);
    break;
  case 'Q':
  default:
    /*
